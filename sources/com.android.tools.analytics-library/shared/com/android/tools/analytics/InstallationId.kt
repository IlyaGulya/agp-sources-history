...
/**
 * Manages a persistent unique installation ID, scoped to a user-machine pair. The ID is unsalted and should *not* be used for metrics or
 * crash reports without further anonymization.
 *
 * This object retrieves a stored UUID from [java.util.prefs.Preferences]. If the ID doesn't exist or is not a valid UUID, it generates a
 * new random UUID, persists it, and returns it.
 */

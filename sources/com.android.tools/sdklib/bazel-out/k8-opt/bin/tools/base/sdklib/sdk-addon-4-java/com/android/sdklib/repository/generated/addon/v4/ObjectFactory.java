 ...
 * generated in the com.android.sdklib.repository.generated.addon.v4 package. 
    ...
    extends AddonFactory
{
    ...
    private final static QName _SdkAddon_QNAME = new QName("http://schemas.android.com/sdk/android/repo/addon2/04", "sdk-addon");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.android.sdklib.repository.generated.addon.v4
     * 
     */
     ...
     */
    @XmlElementDecl(namespace = "http://schemas.android.com/sdk/android/repo/addon2/04", name = "sdk-addon")

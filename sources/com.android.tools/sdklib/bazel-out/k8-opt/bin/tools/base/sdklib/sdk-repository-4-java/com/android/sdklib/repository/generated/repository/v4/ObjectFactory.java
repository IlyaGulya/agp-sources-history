 ...
 * generated in the com.android.sdklib.repository.generated.repository.v4 package. 
    ...
    extends RepoFactory
{
    ...
    private final static QName _SdkRepository_QNAME = new QName("http://schemas.android.com/sdk/android/repo/repository2/04", "sdk-repository");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.android.sdklib.repository.generated.repository.v4
     * 
     */
     ...
     * @return
     *     the new instance of {@link JAXBElement }{@code <}{@link RepositoryType }{@code >}
     */
    @XmlElementDecl(namespace = "http://schemas.android.com/sdk/android/repo/repository2/04", name = "sdk-repository")
